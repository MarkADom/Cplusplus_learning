...
int main()
{
    ...
    // std::flush : flushes the output buffer on its final destination
    std::cout << "This is a nice message... " << std::endl
              << std::flush;
    // After this sdt::flush, we' re sure that at this line, the message has been sent
    //  to the stream. This may be important in some application.

    std::cout << "---------------------" << std::endl;

    // std::setw() : Adust the field with for the item about to be printed.
    ...
    std::cout << std::setw(10) << "Stanley" << std::setw(10) << "Wood" << std::setw(5) << " 33" << std::endl;
    ...
    std::cout << std::setw(10) << "Isaiah" << std::setw(10) << "Robinson" << std::setw(5) << " 29" << std::endl;
    ...
    std::cout << std::setw(col_width) << "Stanley" << std::setw(col_width) << "Wood" << std::setw(col_width / 2) << " 33" << std::endl;
    ...
    std::cout << std::setw(col_width) << "Isaiah" << std::setw(col_width) << "Robinson" << std::setw(col_width / 2) << " 29" << std::endl;
    ...
    // Using setfill to fill the spaces with the specified character
    ...
    // boolalpha and noboolalpha :  control bool out put format : 1/0 or true/false
