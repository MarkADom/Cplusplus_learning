...
int main()
{
        ...
        // 2D arrays
        // int packages [3][4];    // 12 where we can store int's
        ...
        // Using std::size to query the size of array dimensions
        ...
        // 3D arrays defined in the same way. We just use three sets of indexes
        ...
        std::cout << "sizeof(house_block)" << sizeof(house_block) << " bites" << std::endl;
