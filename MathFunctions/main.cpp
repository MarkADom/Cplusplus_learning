...
int main()
{
    ...
    // ceil
    std::cout << "Weight rounder to ceil is : " << std::ceil(weight) << std::endl;
    ...
    // long : reverse function of pow. if 2^3 = 8, log 8 in base 2 =3
    ...
    // log10, 10 ^ 4 = 10000, to get 10k, you need to elevate 10 to power of ? , this is log in base 10
    std::cout << "To get 10000, you need to elevate 10 to power of : " << std::log10(10000) << std::endl; // 4
